...
export ZSH="/Users/sukumar.raghavan/.oh-my-zsh"
...
alias -s {zshrc,vimrc,bashrc}=vim
bindkey -v #vim bindings
d='dirs -v | head -10'
alias grep='grep --color=auto --exclude-dir={.bzr,CVS,.git,.hg,.svn}'

#alias ls='ls --color=tty' # linux/ubuntu

# mac OS-X needs this to show vivid colors
unset LSCOLORS
export CLICOLOR=1
export CLICOLOR_FORCE=1
alias ls='ls -G' # only on OS-X
